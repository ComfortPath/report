...
= Implementation
<chap:implementation>
This chapter describes the technical implementation of the tool. Discussing the data structures and functions used in the code as well as the structure of the entire tool. @fig:implementation shows the connection between the separate components in a graphical manner. 
...
#figure(
  image("../figs/implementation/implementation.png", width: 100%),
  caption: [
...
== Data preparation
#figure(
  image("../figs/implementation/data_prep.png", width: 50%),
  caption: [
...
== Network annotation
#figure(
  image("../figs/implementation/network_anno.png", width: 40%),
  caption: [
...
#figure(
  image("../figs/implementation/zarr_structure.png", width: 50%),
  caption: [
...
#figure(
  ...
  align: alignment.horizon,
    image("../figs/implementation/ui/startup.png", width: 100%),
    image("../figs/implementation/ui/stats_at_12.png", width: 100%),
    image("../figs/implementation/ui/comfort.png", width: 100%),
    image("../figs/implementation/ui/short.png", width: 100%),
    

  ),
  caption: "UI at start-up (top-left), UI when time is set to 12:00 (top-right), UI when comfortable route between OD is chosen (bottom-left), UI when shortest route between OD is chosen (bottom-right)."
)<fig:ui>
#set page(
  paper: "a4",
  flipped: false,
